...
class ExpectedUncertaintyEpsilonComputer(
    ...
    def _compute_epsilon(self, episode: int, epsilon_info: Dict[str, Any]):
        if self._action_function == constants.Constants.MAX:
            computed_epsilon = 1 - 1 / epsilon_info[constants.Constants.CURRENT_STATE_MAX_UNCERTAINTY]
        elif self._action_function == constants.Constants.MEAN:
            computed_epsilon = 1 - 1 / epsilon_info[constants.Constants.CURRENT_STATE_MEAN_UNCERTAINTY]
